...
function Add_EWD_FEUP_Scripts() {
	...
	if (isset($_GET['page']) && $_GET['page'] == 'EWD-FEUP-options') {
		...
		wp_enqueue_script('password-strength', $url_five, array('jquery'));
...
function EWD_FEUP_Add_FrontEnd_Scripts() {
	...
	wp_enqueue_script('ewd-feup-password-strength', EWD_FEUP_CD_PLUGIN_URL . '/js/ewd-feup-check-password-strength.js', array( 'jquery' ));
}
